...
export const getProblem = createPostApi<
  ApiTypes.GetProblemRequestDto,
  ApiTypes.GetProblemResponseDto
>("problem/getProblem", false);
...
export const getAllProblemTagsOfAllLocales = createPostApi<
  void,
  ApiTypes.GetAllProblemTagsOfAllLocalesResponseDto
>("problem/getAllProblemTagsOfAllLocales", false);
export const deleteProblem = createPostApi<
  ApiTypes.DeleteProblemRequestDto,
  ApiTypes.DeleteProblemResponseDto
>("problem/deleteProblem", false);
