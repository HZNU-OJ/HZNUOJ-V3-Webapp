...
export const addJudgeClient = createPostApi<
  ApiTypes.AddJudgeClientRequestDto,
  ApiTypes.AddJudgeClientResponseDto
>("judgeClient/addJudgeClient", false);
...
export const listJudgeClients = createGetApi<
  void,
  ApiTypes.ListJudgeClientsResponseDto
