...
export const searchUser = createGetApi<
  { query: string; wildcard?: string },
  ApiTypes.SearchUserResponseDto
>("user/searchUser");
export const getUserMeta = createPostApi<
  ApiTypes.GetUserMetaRequestDto,
  ApiTypes.GetUserMetaResponseDto
>("user/getUserMeta", false);
...
export const getUserList = createPostApi<
  ApiTypes.GetUserListRequestDto,
  ApiTypes.GetUserListResponseDto
>("user/getUserList", false);
export const getUserDetail = createPostApi<
  ApiTypes.GetUserDetailRequestDto,
  ApiTypes.GetUserDetailResponseDto
>("user/getUserDetail", false);
export const getUserProfile = createPostApi<
...
export const queryAuditLogs = createPostApi<
  ApiTypes.QueryAuditLogsRequestDto,
  ApiTypes.QueryAuditLogsResponseDto
>("user/queryAuditLogs", false);
