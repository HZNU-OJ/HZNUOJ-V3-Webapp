...
!(function (e, t) {
  ...
  var e,
    ...
    I = '[object RegExp]';
  t = function (e) {
    return 'object' == typeof e && (j ? C(e) : T.call(e) === I);
  };
  var F,
  ...
  F = function (e) {
    return (
      'string' == typeof e ||
      ('object' == typeof e && (j ? k(e) : T.call(e) === z))
    );
  };
  var R =
      o.defineProperty &&
  ...
  $(
    r,
    {
      forEach: function (t) {
        var n,
          r = X.ToObject(this),
          o = ne && F(this) ? H(this, '') : r,
          i = -1,
          a = X.ToUint32(o.length);
        ...
        for (; ++i < a; )
          i in o &&
            ('undefined' == typeof n ? t(o[i], i, r) : t.call(n, o[i], i, r));
      },
    },
    !re(r.forEach),
  ),
    $(
      r,
      {
        map: function (t) {
          var r,
            o = X.ToObject(this),
            i = ne && F(this) ? H(this, '') : o,
            a = X.ToUint32(i.length),
            c = n(a);
      ...
      r,
      {
        filter: function (t) {
          ...
          for (var s = 0; s < a; s++)
            s in i &&
              ((n = i[s]),
              ('undefined' == typeof r ? t(n, s, o) : t.call(r, n, s, o)) &&
                Y(c, n));
          return c;
        },
      },
      ...
      r,
      {
        every: function (t) {
          ...
          for (var a = 0; a < i; a++)
            if (
              a in o &&
              !('undefined' == typeof n ? t(o[a], a, r) : t.call(n, o[a], a, r))
            )
              return !1;
          return !0;
        },
      ...
      r,
      {
        reduce: function (t) {
          var n = X.ToObject(this),
            r = ne && F(this) ? H(this, '') : n,
            o = X.ToUint32(r.length);
          if (!e(t))
            throw new TypeError(
  ...
  $(
    ...
    {
      indexOf: function (e) {
        var t = ne && F(this) ? H(this, '') : X.ToObject(this),
          n = X.ToUint32(t.length);
        if (0 === n) return -1;
        var r = 0;
        for (
          arguments.length > 1 && (r = X.ToInteger(arguments[1])),
            r = r >= 0 ? r : w(0, n + r);
          r < n;
          r++
        )
  ...
  $(
    r,
    {
      lastIndexOf: function (e) {
        ...
        var r = n - 1;
        for (
          arguments.length > 1 && (r = O(r, X.ToInteger(arguments[1]))),
  ...
  $(
    r,
    {
      splice: function (e, t) {
        ...
        var n = arguments;
        return (
          (this.length = w(X.ToInteger(this.length), 0)),
          arguments.length > 0 &&
            'number' != typeof t &&
            ((n = J(arguments)),
            n.length < 2 ? Y(n, this.length - e) : (n[1] = X.ToInteger(t))),
          h.apply(this, n)
        );
      },
    },
      ...
      splice: function (e, t) {
        for (
          var n,
            r = X.ToObject(this),
            o = [],
            i = X.ToUint32(r.length),
            a = X.ToInteger(e),
            c = a < 0 ? w(i + a, 0) : O(a, i),
            u = O(w(X.ToInteger(t), 0), i - c),
            l = 0;
          l < u;
        ...
        if (h < u) {
          ...
          for (var d = i - u; l < d; )
            (n = s(l + u)),
              ...
              (l += 1);
          l = i;
          for (var y = i - u + h; l > y; ) delete r[l - 1], (l -= 1);
        } else if (h > u)
          for (l = i - u; l > c; )
            (n = s(l + u - 1)),
              (f = s(l + h - 1)),
  ...
  var ge = function (e) {
      for (
        var t = X.ToObject(this), n = X.ToUint32(t.length), r = 0;
        r < arguments.length;
    ...
    ve = (function () {
      ...
      return (
        1 !== t || 1 !== e.length || 'undefined' != typeof e[0] || !B(e, 0)
      );
    })();
  $(
    r,
    {
      push: function (e) {
        return K(this) ? d.apply(this, arguments) : ge.apply(this, arguments);
      },
    },
    ve,
  );
  ...
  $(
    ...
    {
      sort: function (t) {
        if ('undefined' == typeof t) return V(this);
        if (!e(t))
          throw new TypeError(
  ...
  var Te = !Q({ toString: null }, 'toString'),
    ...
    _e = function (e) {
      if ('undefined' == typeof window || !De) return Ee(e);
      try {
        return Ee(e);
      } catch (t) {
        return !1;
  ...
  $(o, {
    keys: function (t) {
      ...
      var a = [],
        c = je && n;
      if ((i && xe) || r) for (var u = 0; u < t.length; ++u) Y(a, s(u));
      if (!r)
        for (var l in t) (c && 'prototype' === l) || !B(t, l) || Y(a, s(l));
      if (Te)
  ...
  var Re,
    ...
    Xe = new Date(14496624e5),
    Le = 'Mon, 01 Jan -45875 11:59:59 GMT' !== Ae.toUTCString(),
    Be = Ae.getTimezoneOffset();
  Be < -720
    ? ((Re = 'Tue Jan 02 -45875' !== Ae.toDateString()),
      ($e = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(
        Xe.toString(),
      )))
    : ((Re = 'Mon Jan 01 -45875' !== Ae.toDateString()),
      ($e = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(
        Xe.toString(),
      )));
  var Ge = b.bind(Date.prototype.getFullYear),
    Je = b.bind(Date.prototype.getMonth),
    qe = b.bind(Date.prototype.getDate),
    Ze = b.bind(Date.prototype.getUTCFullYear),
    He = b.bind(Date.prototype.getUTCMonth),
    We = b.bind(Date.prototype.getUTCDate),
    Ye = b.bind(Date.prototype.getUTCDay),
    Qe = b.bind(Date.prototype.getUTCHours),
    Ve = b.bind(Date.prototype.getUTCMinutes),
    Ke = b.bind(Date.prototype.getUTCSeconds),
    et = b.bind(Date.prototype.getUTCMilliseconds),
  ...
  var ot = -621987552e5,
    ...
    st = b.bind(Date.prototype.getTime);
  $(
    Date.prototype,
    {
  ...
  if (pt || ft || !lt) {
    var ht = Math.pow(2, 31) - 1,
      dt = A(new Date(1970, 0, 1, 0, 0, 0, ht + 1).getTime());
    Date = (function (e) {
      var t = function (n, r, o, i, a, c, u) {
          ...
          return U(l) || $(l, { constructor: t }, !0), l;
        },
        n = new RegExp(
      ...
      $(t, { now: e.now, UTC: e.UTC }, !0),
        (t.prototype = e.prototype),
        $(t.prototype, { constructor: t }, !0);
      var c = function (t) {
        var r = n.exec(t);
        if (r) {
          var a,
          ...
          return f < (m ? 24 : 25) &&
            ...
            u > -1 &&
            u < o(c, s + 1) - o(c, s) &&
            ((a = 60 * (24 * (o(c, s) + u) + f + v * g)),
            (a = 1e3 * (60 * (a + p + b * g) + h) + d),
            y && (a = i(a)),
            -864e13 <= a && a <= 864e13)
            ? a
            : NaN;
    ...
    vt = function (e) {
      ...
      if (((r = ''), n < 0 && ((r = '-'), (n = -n)), (o = '0'), n > 1e-21))
        if (
          ...
          gt.multiply(0, a),
            gt.multiply(1 << -i, 0),
            (o = gt.numToString() + Z('0.00000000000000000000', 2, 2 + t));
      return (
        t > 0
          ? ((u = o.length),
            (o =
              u <= t
                ? r + Z('0.0000000000000000000', 0, t - u + 2) + o
                : r + Z(o, 0, u - t) + '.' + Z(o, u - t)))
          : (o = r + o),
        o
      );
  ...
  $(
    f,
    {
      toPrecision: function (e) {
        return 'undefined' == typeof e ? mt.call(this) : mt.call(this, e);
      },
    },
    bt,
  ),
    ...
    '.'.split(/()()/).length > 1
      ? !(function () {
          ...
          u.split = function (r, o) {
            ...
            var y = 'undefined' == typeof o ? n : X.ToUint32(o);
            for (
              c = h.exec(i);
              c &&
                ...
                !e &&
                  ...
                  c[0].replace(a, function () {
                    for (var e = 1; e < arguments.length - 2; e++)
                      'undefined' == typeof arguments[e] && (c[e] = void 0);
                  }),
                c.length > 1 && c.index < i.length && d.apply(l, J(c, 1)),
                (u = c[0].length),
                (p = s),
                l.length >= y)
              ));
            ...
            return (
              p === i.length ? (!u && h.test('')) || Y(l, '') : Y(l, Z(i, p)),
              l.length > y ? J(l, 0, y) : l
            );
          };
        })()
    ...
    (u.replace = function (n, r) {
      ...
      if (o && i) {
        var a = function (e) {
          ...
          return (
            (n.lastIndex = o),
            Y(i, arguments[t - 2], arguments[t - 1]),
            r.apply(this, i)
          );
        };
  ...
  var Tt = u.substr,
    jt = ''.substr && 'b' !== '0b'.substr(-1);
  $(
    u,
    {
      substr: function (e, t) {
        var n = e;
        return e < 0 && (n = w(this.length + e, 0)), Tt.call(this, n, t);
      },
    },
    jt,
  );
  ...
  var Pt = b.bind(String.prototype.trim),
    Ct =
      u.lastIndexOf && 'abc\u3042\u3044'.lastIndexOf('\u3042\u3044', 2) !== -1;
  $(
    u,
    {
      lastIndexOf: function (e) {
  ...
  if (
    ...
    (8 === parseInt(xt + '08') && 22 === parseInt(xt + '0x16')) ||
      (parseInt = (function (e) {
        var t = /^[\-+]?0[xX]/;
        return function (n, r) {
          var o = Pt(String(n)),
    ...
    var Ft = function () {
      ...
      var t = this.message;
      return (
        'undefined' == typeof t ? (t = '') : 'string' != typeof t && (t = s(t)),
        e ? (t ? e + ': ' + t : e) : t
      );
    };
  ...
  (function (e, t) {
    ...
    var e,
      ...
      c = o.bind(i.propertyIsEnumerable),
      s = o.bind(i.toString),
    ...
    if (!Object.getOwnPropertyDescriptor || d) {
      ...
      Object.getOwnPropertyDescriptor = function (e, t) {
        ...
        var s;
        if (!a(e, t)) return s;
        if (((s = { enumerable: c(e, t), configurable: !0 }), u)) {
          var f = e.__proto__,
            p = e !== i;
          p && (e.__proto__ = i);
          var h = n(e, t),
            g = r(e, t);
          if ((p && (e.__proto__ = f), h || g))
            return h && (s.get = h), g && (s.set = g), s;
        }
    ...
    if (
      ...
      var g,
        v = !({ __proto__: null } instanceof Object),
        b = function () {
    ...
    if (Object.defineProperty) {
      var T = O({}),
        j = 'undefined' == typeof document || O(document.createElement('div'));
      if (!T || !j)
    ...
    if (!Object.defineProperty || x) {
      ...
      Object.defineProperty = function (o, a, c) {
        if (l(o)) throw new TypeError(D + o);
        if (l(c)) throw new TypeError(S + c);
        if (x)
          try {
            return x.call(Object, o, a, c);
          } catch (s) {}
        if ('value' in c)
          if (u && (n(o, a) || r(o, a))) {
            var f = o.__proto__;
          ...
          var p = 'get' in c,
            h = 'set' in c;
          if (!u && (p || h)) throw new TypeError(_);
          p && e(o, a, c.get), h && t(o, a, c.set);
        }
        return o;
      };
    }
  ...
  (function (e) {
    ...
    for (
      var t,
        ...
        i = function () {},
        a = 'memory'.split(','),
        c = 'assert,clear,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profiles,profileEnd,show,table,time,timeEnd,timeline,timelineEnd,timeStamp,trace,warn'.split(
          ',',
        );
      (t = a.pop());
      ...
      r[t] || (r[t] = o);
    for (; (n = c.pop()); ) 'function' != typeof r[n] && (r[n] = i);
  ...
  (function (e, t) {
    ...
    var n = function () {
        ...
        return (
          (e.style.cssText = 'font-size: 1rem;'), /rem/.test(e.style.fontSize)
        );
      },
      r = function () {
        for (
          var e = document.getElementsByTagName('link'), t = [], n = 0;
          n < e.length;
          n++
        )
      ...
      o = function () {
        for (var e = 0; e < h.length; e++) l(h[e], i);
      },
      i = function (e, t) {
        if ((v.push(e.responseText), b.push(t), b.length === h.length)) {
          for (var n = 0; n < b.length; n++) a(v[n], b[n]);
          (h = d.slice(0)).length > 0
            ? ((b = []), (v = []), (d = []), o())
            : c();
        }
      },
      a = function (e, t) {
        for (
          var n,
            r = f(e).replace(/\/\*[\s\S]*?\*\//g, ''),
            o = /[\w\d\s\-\/\\\[\]:,.'"*()<>+~%#^$_=|@]+\{[\w\d\s\-\/\\%#:!;,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!;,.'"*()]*\}/g,
            i = r.match(o),
            a = /\d*\.?\d+rem/g,
            c = r.match(a),
            s = /(.*\/)/,
      ...
      s = function () {
        for (var e = 0; e < g.length; e++)
          m[e] =
            Math.round(parseFloat(g[e].substr(0, g[e].length - 3) * w)) + 'px';
        u();
      },
      u = function () {
        for (var e = 0; e < m.length; e++) m[e] && (p = p.replace(g[e], m[e]));
    ...
    if (!n()) {
      ...
      (w = (function () {
        ...
        return (
          ...
          r.appendChild(i),
          (e = i.offsetWidth),
          o ? n.removeChild(r) : (r.removeChild(i), (r.style.fontSize = a)),
          e
        );
      })()),
        o();
  ...
  (function (e) {
    ...
    if (
      ...
      var c,
        ...
        y = {},
        g = 30,
        v = l.getElementsByTagName('head')[0] || f,
        b = l.getElementsByTagName('base')[0],
        m = v.getElementsByTagName('link'),
        w = function () {
          var e,
          ...
          return (
            ...
            n ||
              ((n = i = l.createElement('body')),
              (n.style.background = 'none')),
            (f.style.fontSize = '100%'),
            (n.style.fontSize = '100%'),
            n.appendChild(t),
            i && f.insertBefore(n, f.firstChild),
            (e = t.offsetWidth),
            i ? f.removeChild(n) : n.removeChild(t),
            (f.style.fontSize = r),
        ...
        O = function (t) {
          var n = 'clientWidth',
            r = f[n],
            o = ('CSS1Compat' === l.compatMode && r) || l.body[n] || r,
            i = {},
            a = m[m.length - 1],
            y = new Date().getTime();
          if (t && c && g > y - c)
          ...
          for (var b in p)
            if (p.hasOwnProperty(b)) {
              var T = p[b],
                ...
                S = null === x,
                D = 'em';
              j && (j = parseFloat(j) * (j.indexOf(D) > -1 ? u || w() : 1)),
                x && (x = parseFloat(x) * (x.indexOf(D) > -1 ? u || w() : 1)),
                (T.hasquery &&
                  ((E && S) || !(E || o >= j) || !(S || x >= o))) ||
                  (i[T.media] || (i[T.media] = []),
                  i[T.media].push(h[T.rules]));
            }
          for (var _ in d)
            d.hasOwnProperty(_) &&
              d[_] &&
          ...
          for (var M in i)
            if (i.hasOwnProperty(M)) {
              ...
              (P.type = 'text/css'),
                (P.media = M),
                v.insertBefore(P, a.nextSibling),
                P.styleSheet
                  ? (P.styleSheet.cssText = C)
                  : P.appendChild(l.createTextNode(C)),
                d.push(P);
            }
        },
        T = function (e, t, r) {
          ...
          for (var u = 0; i > u; u++) {
            ...
            s
              ? ((l = r), h.push(c(e)))
              : ((l = o[u].match(n.regex.findStyles) && RegExp.$1),
                h.push(RegExp.$2 && c(RegExp.$2))),
              (d = l.split(',')),
              (y = d.length);
            for (var g = 0; y > g; g++)
              (f = d[g]),
          ...
          for (var t = 0; t < m.length; t++) {
            ...
            o &&
              ...
              (n.styleSheet && n.styleSheet.rawCssText
                ...
                : ((!/^([a-zA-Z:]*\/\/)/.test(o) && !b) ||
                    o.replace(RegExp.$1, '').split('/')[0] ===
                      e.location.host) &&
                  ('//' === o.substring(0, 2) && (o = e.location.protocol + o),
                  r.push({ href: o, media: i })));
          }
          j();
        };
      x(),
